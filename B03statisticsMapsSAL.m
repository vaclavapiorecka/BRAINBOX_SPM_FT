...
% ===========================================================
% vstup:    absolute power 1Hz bandsmapované na mozek, psilocin (soubor: RB02mapsSAL.mat)
% výstup:   statistika map, (soubor: RB03statisticsMapsTreatSAL.mat)
% ===========================================================
%%
...
load('RB02mapsSAL.mat')        % load maps01-maps04
